...
- 适用版本：RemoteOps `0.2.0-preview.4`
...
```text
artifacts/release/0.2.0-preview.4/windows-x64/manifest.json
artifacts/linux-x64/manifest.json
```

部署前必须确认所有正式组件为 `0.2.0-preview.4`，并保留 Release 中的 SHA-256 用于传输后核对。串口 Demo 仍独立使用 `0.5.0`。
