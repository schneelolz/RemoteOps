...
1. `RemoteOps-MCP-macOS-arm64-0.2.0-preview.1.tar.gz`；
...
```bash
tar -xzf RemoteOps-MCP-macOS-arm64-0.2.0-preview.1.tar.gz
cd RemoteOps-MCP-macOS-arm64-0.2.0-preview.1
