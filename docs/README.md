...
RemoteOps `0.2.0-preview.1` 当前源码候选不内置公共 Relay 地址；该版本计划作为首个 GitHub Technical Preview。部署者必须通过配置文件、环境变量或命令行参数提供自己的 Relay；公网 CA 使用系统可信根，私有 CA 可以配置 PEM，Agent GUI 也支持人工核对并固定 SHA-256 指纹。
